-- Berkeley Memory Map Database Schema - Clean Version
...
DROP POLICY IF EXISTS "Friends memories are visible to friends" ON public.memories;
DROP POLICY IF EXISTS "Private memories are visible only to author" ON public.memories;
...
DROP POLICY IF EXISTS "Memory links are visible to memory owners" ON public.memory_links;
DROP POLICY IF EXISTS "Users can create memory links for their memories" ON public.memory_links;
...
DROP POLICY IF EXISTS "Places are visible to all" ON public.places;
